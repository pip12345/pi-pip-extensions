...
4. Gather information. Read/search relevant code, docs, config, and tests in the codebase. Use websearch for gathering online information.
5. Identify the existing abstraction or pattern in the codebase in which the change should fit.
6. Give a short plan.
